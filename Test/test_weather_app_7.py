"""
Record and replay test for case insensitivity in city names
"""
import sys
import unittest
...
class TestWeatherApp7(unittest.TestCase):
    def setUp(self):
        ...
        self.recording_file = 'test_recordings/case_insensitivity.json'
    ...
    def test_case_insensitivity(self):
        ...
        if self.record_mode:
            ...
            for idx, recording in enumerate(recordings):
                ...
                # Verify results are consistent across different case variants
