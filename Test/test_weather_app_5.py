"""
Record and replay test for special characters in city name
"""
import sys
import unittest
...
class TestWeatherApp5(unittest.TestCase):
    def setUp(self):
        ...
        self.recording_file = 'test_recordings/special_characters.json'
    ...
    def test_special_characters(self):
        """Tests handling of special characters in city names"""
        special_char_cities = ["São Paulo", "Köln", "Nîmes"]
        ...
        if self.record_mode:
            ...
            for city in special_char_cities:
